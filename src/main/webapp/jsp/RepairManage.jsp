...
<div class="app-container">
                    ...
                    <div class="col-xs-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select name="rType">
                                                ...
                                                <option value="1">家庭设备</option>
                                                <option value="0">公用设备</option>
                                            </select>
                                        </td>
                                        <td>
                                            <label>审核情况</label>
                                        ...
                                        <td>
                                            ...
                                            <td>
                                                <input type="text" name="rPhone" value="" placeholder="输入报修人电话号码"/>
                                            </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <input type="text" name="rId" value="" placeholder="输入报修单ID"/>
                                        </td>
                                        <td>
                                            <label>报修人名称：</label>
                                        </td>
                                        <td>
                                            <input type="text" name="rName" value="" placeholder="输入报修人名称关键字"/>
                                        </td>
                                        <td>
                                ...
                                <table class="datatable table table-striped" table id="repairApplicationManage" cellspacing="0" width="100%">
    ...
    <div></div>
        ...
        <script type="text/javascript" src="../js/RepairManage.js"></script>
