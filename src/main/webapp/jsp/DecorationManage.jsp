...
<div class="app-container">
                            ...
                            <div class="card-body">
                                <table id="menuTable" class="table" cellspacing="0" width="100%">
                                    <tr>
                                        ...
                                        <td>
                                            <input name="dDateS" type="date"/>
                                        </td>
                                        <td>
                                            <label>结束日期</label>
                                        </td>
                                        <td>
                                            <input name="dDateE" type="date"/>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" name="dPhone" value="" placeholder="输入装修人电话号码"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <input type="text" name="dId" value="" placeholder="输入装修单ID"/>
                                        </td>
                                        <td>
                                            <label>装修人名称：</label>
                                        </td>
                                        <td>
                                            <input type="text" name="dName" value="" placeholder="输入装修人名称"/>
                                        </td>
                                        <td>
                                            <%--<a href=\queryDecoration.do><i name="searchBtn" class="fa fa-search"></i>&nbsp;查询</a>--%>
                                            <button type="button" name="查询" id="dquery" value="查询" onclick="queryDecoration()">查询</button>
                                        </td>
                                    </tr>
                                </table>
                                <table class="datatable table table-striped" table id="decorationApplicationManage" cellspacing="0" width="100%">
    ...
    <footer class="app-footer">
        ...
        <script type="text/javascript" src="../js/DecorationManage.js"></script>
