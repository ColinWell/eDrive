            ...
            <div class="container-fluid">
                <div class="side-body">
                    <div class="page-title">
                        <span class="title">缴费规则查询</span>
                        <div class="description">便捷地查询所需的缴费规则信息</div>
                    </div>
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <table id="menuTable" class="table" cellspacing="0" width="100%">
                                        <tr>
                                            ...
                                            <td>
                                                <a class="add-popup" href="javascript:addPaymentRule();"><i name="addBtn" class="fa fa-plus"></i>&nbsp;新增</a>
                                            </td>
                                        </tr>
                                        <tr>
                                            <%--<td>--%>
                                            ...
                                            <td>
                                                <input type="text" name="ruleVersion" value="" onkeyup="value=value.replace(/[^\d]/g,'')" placeholder="输入版本号查询"/>
                                            </td>
                                            <td>
                                                <a href="javascript:queryPaymentRule();"><i name="searchBtn" class="fa fa-search"></i>&nbsp;查询</a>
                                            </td>
                                        </tr>
                                    </table>
                                    <table id="paymentRuleQuery" class="table table-striped" cellspacing="0" width="100%">
                                        <thead>
                                            <tr>
                                                <th>ID</th>
                                                <th>规则类型</th>
                                        ...
                                        <form class="form-horizontal">
                                            <fieldset>
                                                ...
                                                <div class="form-group">
                                                    <label class="col-md-4 control-label" for="name.type">规则类型</label>
                                                    <div class="col-md-6">
                                                        <select id="name.type" name="name.type" class="form-control input-md">
                                                            <option value="1" selected>物业费</option>
                                                            <option value="2">公共物业水电费</option>
                                                            <option value="3">停车费</option>
                                                        </select>
                                                        <span class="help-block">选择费用类型</span>
                                                    </div>
                                                </div>
                                                <!-- Text input-->
                                                <div class="form-group">
                                                    <label class="col-md-4 control-label" for="name.version">规则版本</label>
                                                    <div class="col-md-6">
                                                        <input id="name.version" name="name.version" type="text" placeholder="" class="form-control input-md"  value="">
                                                        <span class="help-block">相应费用类型的缴费规则版本（已存在/为空则默认递增）</span>
                                                    </div>
                                                </div>
                                                <!-- Text input-->
                                                <div class="form-group">
                                                    <label class="col-md-4 control-label" for="name.fee">缴费金额</label>
                                                    <div class="col-md-6">
                                                        <input id="name.fee" name="name.fee" type="number" placeholder="" class="form-control input-md"  value="">
                                                        <span class="help-block">相应费用类型的缴费金额</span>
                                                    </div>
                                                </div>
                                                <!-- Button (Double) -->
                                                <div class="form-group">
