                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="card-title">
                                    <div class="title">装修申请</div>
                                    <a class="add-popup" style="cursor:pointer;float:right;">新增</a>
                                </div>
                            </div>

                            <div class="card-body">

                                <table class="table"  id="emergencyManage" cellspacing="0" width="100%">
                                ...
                                <div id="add-popup" class="popup">
                                    <form class="form-horizontal">
                                        <fieldset>
                                            <!-- Form Name -->
                                            <legend>新增紧急联系人</legend>
                                            <!-- Text input-->
                                            <div class="form-group">
                                                <label class="col-md-4 control-label" for="name">紧急联系人姓名</label>
                                                <div class="col-md-6">
                                                    <input id="name" name="name" type="text" placeholder="" class="form-control input-md"  value="">

                                                </div>
                                            </div>
                                            <!-- Text input-->
                                            <div class="form-group">
                                                <label class="col-md-4 control-label" for="phone">紧急联系人电话</label>
                                                <div class="col-md-6">
                                            ...
                                            <!-- Text input-->
                                            <div class="form-group">
                                                <label class="col-md-4 control-label" for="time">负责时间段</label>
                                                <div class="col-md-6">
                                                    <input id="time" name="time" type="text" placeholder="" class="form-control input-md"  value="">
...
<script type="text/javascript" src="../js/EmergencyManage.js"></script>
</html>
