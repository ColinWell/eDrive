                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active panel panel-default dropdown">
                            ...
                            <div id="dropdown-table" class="panel-collapse collapse">
                                <div class="panel-body">
                                    <ul class="nav navbar-nav">
                                        <li><a href="#">推送通知至个别用户</a>
                                        </li>
                                        <li><a href="./announce.jsp">推送公告至全部用户</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
        ...
        <div class="container-fluid">
            <div class="side-body">
                <div class="page-title">
                    ...
                    <div class="description">便捷地查询或发布通知信息</div>
                </div>
                <div class="row">
                    <div class="col-xs-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <table id="menuTable" class="table" cellspacing="0" width="100%">
                                    <tr>
                                        ...
                                        <td>
                                            <select name="noticeState" style="width:70px !important;">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" name="recUserName" value="" placeholder="输入接收者名称"/>
                                        </td>
                                        <td>
                                            <label>发布者：</label>
                                        </td>
                                        ...
                                        <td>
                                            <a href="javascript:queryNotice();"><i name="searchBtn" class="fa fa-search"></i>&nbsp;查询</a>
                                        </td>
                                    </tr>
                                </table>
                                <table id="noticeQuery" class="table table-striped" cellspacing="0" width="100%">
                                    <thead>
                                    <tr>
                                        <th>ID</th>
                                        <th>通知发布时间</th>
                                ...
                                <div id="add-popup" class="popup">
                                    <form class="form-horizontal">
                                        <fieldset>
                                            <!-- Form Name -->
                                            <legend>发布个人通知</legend>
                                            <!-- Text input-->
                                            <div class="form-group">
                                                <label class="col-md-4 control-label" for="receiver">请选择接收人：</label>
                                                <div class="col-md-6">
                                                    <select id="receiver" name="receiver"  class="form-control input-md"  >
                                                    </select>
                                                    <span class="help-block">选取接收人</span>
                                                </div>
                                            </div>
                                            <!-- Text input-->
                                            <div class="form-group">
                                                <label class="col-md-4 control-label" for="name.content">通知内容</label>
                                                <div class="col-md-6">
                                                    <textarea class="form-control" id="name.content" name="name.content"></textarea>
                                                    <span class="help-block">输入通知的内容</span>
                                                </div>
                                            </div>
                                            <!-- Button (Double) -->
                                            <div class="form-group">
