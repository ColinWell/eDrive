        ...
        <div class="container-fluid">
            <div class="side-body">
                <div class="page-title">
                    <span class="title">装修申请细则编辑</span>
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="card-title">
                                    <div class="title">装修申请细则</div>
                                </div>
                            </div>

                            <div class="card-body">
                                装修细则：1.装修时间要在2个月内。2.装修申请要提前1个月。3.只能申请装修自己家。4.装修不能扰民。
                                <div class="sub-title">细则编辑</div>
                                <div>
                                    <input type="text" class="form-control" placeholder="Text input">
                                </div>
                                <button type="submit" class="btn btn-default" id="dRuleChange">修改</button>
                            </div>
...
<script type="text/javascript" src="../js/DecorationRule.js"></script>
