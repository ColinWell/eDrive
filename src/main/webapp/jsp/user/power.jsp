                            ...
                            <div id="dropdown-table" class="panel-collapse collapse">
                                <div class="panel-body">
                                    <ul class="nav navbar-nav">
                                        ...
                                        <li><a href="../notice/query.jsp">通知查询</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
        ...
        <div class="container-fluid">
            <div class="side-body">
                <div class="page-title">
                    ...
                    <div class="description">便捷地为用户分配相应权限</div>
                </div>
                <div class="row">
                    <div class="col-xs-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <table id="menuTable" class="table" cellspacing="0" width="100%">
                                    <tr>
                                        ...
                                        <td>
                                            <a href="javascript:queryPower();"><i name="searchBtn" class="fa fa-search"></i>&nbsp;查询</a>
                                        </td>
                                        <td>
                                            <a class="add-popup" href="javascript:addUser();"><i name="addBtn" class="fa fa-plus"></i>&nbsp;新增</a>
                                        </td>
                                    </tr>
                                </table>
                                <table id="powerQuery" class="table table-striped" cellspacing="0" width="100%">
                                    <thead>
                                    <tr>
                                        <th>#</th>
                                        <th>用户ID</th>
                                    ...
                                    <form class="form-horizontal">
                                        <fieldset>
                                            ...
                                            <div class="form-group">
                                                <label class="col-md-4 control-label" for="name.id">用户ID</label>
                                                <div class="col-md-6">
                                                    <input id="name.id" name="name.id" type="" placeholder="" class="form-control input-md"  value="">
                                                    <span class="help-block">规则的唯一标识符</span>
                                                </div>
                                            </div>
                                            <!-- Text input-->
                                            <div class="form-group">
                                                <label class="col-md-4 control-label" for="name.name">用户名称</label>
                                                <div class="col-md-6">
                                                    <input id="name.name" name="name.name" type="text" placeholder="" class="form-control input-md"  value="">
                                                    <span class="help-block">用户显示昵称</span>
                                                </div>
                                            </div>
                                            <!-- Text input-->
                                            <div class="form-group">
                                                <label class="col-md-4 control-label" for="name.password">用户密码</label>
                                                <div class="col-md-6">
                                                    <input id="name.password" name="name.password" type="password" placeholder="" class="form-control input-md"  value="">
                                                    <span class="help-block">用户登录密码</span>
                                                </div>
                                            </div>
                                            <!-- Text input-->
                                            <div class="form-group">
                                                <label class="col-md-4 control-label" for="name.role">用户权限</label>
                                                <div class="col-md-6">
                                                    <input id="name.role" name="name.role" type="text" placeholder="" class="form-control input-md"  value="">
                                                    <span class="help-block">该用户所具有的权限</span>
                                                </div>
                                            </div>
                                            <!-- Button (Double) -->
                                            <div class="form-group">
...
<script type="text/javascript" src="../../js/user/power.js"></script>
</body>
