        ...
        <div class="container-fluid">
            <div class="side-body">
                <div class="page-title">
                    <span class="title">用户房屋关系审核</span>
                    <div class="description">审核用户和房屋的绑定关系</div>
                </div>
                <div class="row">
                    <div class="col-xs-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <table id="menuTable" class="table" cellspacing="0" width="100%">
                                    <tr>
                                        ...
                                        <td>
                                            <a href="javascript:queryRelation();"><i name="searchBtn" class="fa fa-search"></i>&nbsp;查询</a>
                                        </td>
                                        <td>
                                ...
                                <table id="relationQuery" class="table table-striped" cellspacing="0" width="100%">
                                    <thead>
                                    <tr>
                                        <th>#</th>
                                        <th>用户ID</th>
